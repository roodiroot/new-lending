        ...
        <div className="w-full max-w-2xl mx-auto lg:max-w-none">
          <div className="max-w-3xl space-y-8">
            ...
            <p className="  xl:text-lg text-accent dark:text-white font-medium">
              Наш бриф состоит из трех простых вопросов, которые помогут нам
              лучше понять ваши цели и потребности. Заполните его, и мы свяжемся
              с вами для обсуждения деталей вашего проекта.
            </p>
          </div>
